					...
					items: [
						...
						{ label: '権限と認可', link: '/spec/authz/' },
						{
							...
							items: [
								...
								{ label: 'SCR-C01 PJ一覧', link: '/spec/screens/scr-c01/' },
								{ label: 'SCR-C02 PJ詳細', link: '/spec/screens/scr-c02/' },
								{ label: 'SCR-C03 タスク管理', link: '/spec/screens/scr-c03/' },
								{ label: 'SCR-C04 工数入力', link: '/spec/screens/scr-c04/' },
								{ label: 'SCR-C05 工数集計', link: '/spec/screens/scr-c05/' },
							],
						},
						{
							label: 'API仕様',
							...
							items: [
								...
								{ label: 'API-C03 工数入力', link: '/spec/apis/api-c03/' },
								{ label: 'API-C04 工数集計', link: '/spec/apis/api-c04/' },
